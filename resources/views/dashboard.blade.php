        ...
        <div class="grid grid-cols-1 px-5 gap-4 md:w-3/3">
            <div class="md:w-2/3 md:mx-auto">
                ...
                <div class="relative flex justify-center my-3 ">
                    <input type="text" placeholder="Search Countries" class="countrySearch w-full md:w-1/2 px-3 py-2 rounded-lg border border-gray-300 shadow-sm focus:outline-none focus:border-blue-500 focus:ring-blue-500">
...
{{--            </div>--}}
            ...
            <div class="flex flex-col justify-center gap-1" id="country-select">
                <div class="grid md:grid-cols-5 gap-4">
                    @foreach ($countries as $country)
                        <a href="/country/{{ $country->iso_code }}" class="block w-full country-selection" data-country-name="{{ $country->country }}">
                            <div class="relative w-full h-72 md:h-96 rounded-lg overflow-hidden hover:cursor-pointer transition-transform duration-500 ease-in-out transform md:hover:scale-105">
                                <div class="absolute inset-0">
                                    <img
                                        src="{{$country->country_img}}"
                                        alt="country image"
                                    ...
                                    />
                                    <div class="absolute inset-0 bg-black bg-opacity-40 flex flex-col justify-end p-4 rounded-lg">
                                        <h2 class="text-white text-xl md:text-2xl lg:text-3xl font-bold">{{ $country->country }}</h2>
                                    </div>
                                </div>
                            </div>
                        </a>
